...
(function (window) {
    ...
    function RankFlowVis() {
        ...
        this.resize = function () {
            ...
            if (this.windowWidth != document.body.clientWidth) {
                ...
                this.resizeTimer = setTimeout(function () {
                    ...
                    setupvis();
                    builtChart();
                    // vis(selectedDataset.videos); /////// CHECK LATER!!
        ...
        this.vis = function (data) {
            ...
            // this.visDataset.forEach(function (d, i) {
            //     console.log(this)
            //     this.allVideosIDs[i] = d.id;
            //     this.namesByID[d.id] = i;
            //     saveChannel(d.channel);
            ...
            ///////////////////// redefine color
            // color.domain(this.allVideosIDs);
        ...
        this._getFlatDataById = function (id) {

            // $.each(this.flatData,function(i,d) {
